...
public class SavingAccount extends Account {
    ...
    public int yearChange() {
        if (maxBalance == minBalance) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть равен минимальному"
            );
        }
        if (minBalance > balance) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть больше начального баланса"
            );
        }
        if (maxBalance < balance) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть больше начального баланса"
            );
        }
    ...
    public int getMinBalance() {
        ...
        if (minBalance > maxBalance) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть больше максимального баланса"
            );
        }
        return minBalance;
    }
